                                    ...
                                    <div class="z-depth-5 main">
                                        <div class="row">
                                            <div class="col-sm-6 picture">
                                                <center><img class="circle-img main-profile-img" height="150px" src="{{ $user->image_path }}"><span><a class="btn-floating pulse waves-effect waves-light add"></a></span></center>
                                            </div>
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                   ...
                                                   <td><a  href="{{ route('show-user-order') }}" class="btn-small d-block">View</a></td> 
                                                </tr>
                                            </thead>
                                            <tbody>
