...
<section class="content-main">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xl col-lg my-3">
                    ...
                    <p class="mb-0 text-muted">@lang('seller.Bio'): <span class="">{{ $store->bio }}</span></p>
                </div> <!--  col.// -->
                <div class="col-xl col-lg">
                    ...
                    <select class="form-select w-auto d-inline-block" id="storeActive">
                        <option data-value="1" data-url="{{ route('update.active') }}" data-id="{{ $store->id }}" {{ $store->active == 1 ? 'selected' : '' }}>@lang('seller.Active')</option>
                        <option data-value="0" data-url="{{ route('update.active') }}" data-id="{{ $store->id }}" {{ $store->active == 0 ? 'selected' : '' }}>@lang('seller.Inactive')</option>
                    </select>
                </div>
            </div> <!-- card-body.// -->
        </div> <!--  card-body.// -->
    ...
    <div class="pagination-area mt-30 mb-50">
          @include('paginations.pagination',$products)
    </div>
