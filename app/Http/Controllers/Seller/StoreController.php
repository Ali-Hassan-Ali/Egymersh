...
class StoreController extends Controller
{
    ...
    {
        $products = SellerProduct::where('store_id', $store->id)->latest()->paginate(25);
    ...
    public function destroy(Store $store)
    {
        ...
        try {
            ...
            $StoreSellers = SellerProduct::where('store_id',$store->id)->get();

            foreach ($StoreSellers as $product) {

                Storage::disk('local')->delete('public/products_seller/' . $product->defult_image);
